...
<div class="mmtopnav">
 ...
 <div class="mmart" style="font-family: 'Kumar One Outline',red serifs;text-decoration-line:underline;height:auto;">ART GALLERY</div>
...
<a href="homepage.php?logout='1'" style="float:right;position:relative;">logout</a>

   <div class="mmart" style="font-family: 'Kumar One Outline',red serifs;text-decoration-line:underline;float:right;height:48px;text-align:center;padding: 0px  16px;">
...
<div class="topnav" id="myTopnav">
  ...
  <a href="#home" class="home" ><img id="myImg" src="images\i2.png" alt="Northern Lights, Norway" width="100" height="35"></a>
...
<div id="lmyNav" class="loverlay">
  ...
  <div class="loverlay-content">
    ...
    <div class="s" style="font-size:30px;cursor:pointer">
    <?php  if (isset($_SESSION['username'])) : ?>
    	<p>Welcome <strong><?php echo $_SESSION['username']; ?></strong></p>
	...
	<div class="l">
	<a href="homepage.php?logout='1'" style="font-size:30px;cursor:pointer">logout</a>
